   ...
   config_(cfg)
{
    ...
    HistClass::CreateHisto(4,"Tau_eta","Tau_eta", 80, -4, 4, "#eta_{#tau}");
    HistClass::CreateHisto(4,"Tau_phi","Tau_phi", 40, -3.2, 3.2, "#phi_{#tau} (rad)");
    ...
    HistClass::CreateHisto(4,"Tau_ET_MET","Tau_ET_MET",50, 0, 6,"p^{#tau}_{T}/E^{miss}_{T}");
    ...
    HistClass::CreateHisto(4,"Tau_Vtx_Y","Tau_Vtx_Y", 100, -1, 1, "Vtx_{y}^{#tau} (cm)");
    HistClass::CreateHisto(4,"Tau_Vtx_Z","Tau_Vtx_Z", 200, -30, 30, "Vtx_{z}^{#tau} (cm)");
    //HistClass::CreateHisto(4,"Tau_EtaEta","Tau_EtaEta", 200, -1, 1, "#eta#eta_{#tau}");
    //HistClass::CreateHisto(4,"Tau_EtaPhi","Tau_EtaPhi", 200, -1, 1, "#eta#phi_{#tau}");
    //HistClass::CreateHisto(4,"Tau_PhiPhi","Tau_PhiPhi", 200, -1, 1, "#phi#phi_{#tau}");
    //HistClass::CreateHisto(4,"Tau_NumSignaltracks","Tau_NumSignaltracks", 40, -3, 37, "N_{sig tracks}^{#tau}");
    HistClass::CreateHisto(4,"Tau_NumPFChargedHadrCands","Tau_NumPFChargedHadrCands", 40, -3, 37, "N_{PFChargedHadrCands}^{#tau}");
    HistClass::CreateHisto(4,"Tau_NumPFGammaCands","Tau_NumPFGammaCands", 40, -3, 37, "N_{PFGammaCands}^{#tau}");
    HistClass::CreateHisto(4,"Tau_NumPFNeutralHadrCands","Tau_NumPFNeutralHadrCands", 40, -3, 37, "N_{PFNeutralHadrCands}^{#tau}");
    HistClass::CreateHisto(4,"Tau_LeadingHadronPt","Tau_LeadingHadronPt", 5000, 0, 5000, "p_{T}^{leading hadron} (GeV)");
    HistClass::CreateHisto(4,"Tau_EMFraction","Tau_EMFraction", 100, 0, 10, "EM Fraction^{#tau}");
    HistClass::CreateHisto(4,"Tau_HcalEoverLeadChargedP","Tau_HcalEoverLeadChargedP", 100, 0, 10, "#frac{E_{Hcal}}{P_{leading charged}}");
    HistClass::CreateHisto(4,"Tau_EcalEnergy","Tau_EcalEnergy", 5000, 0, 5000, "E_{Ecal}^{#tau} (GeV)");
    HistClass::CreateHisto(4,"Tau_HcalEnergy","Tau_HcalEnergy", 5000, 0, 5000, "E_{Hcal}^{#tau} (GeV)");
    HistClass::CreateHisto(4,"Tau_Jet_pt","Tau_Jet_pt", 5000, 0, 5000, "p_{T}^{jet} (GeV)");
    HistClass::CreateHisto(4,"Tau_Jet_eta","Tau_Jet_eta", 80, -4, 4, "#eta_{jet}");
    HistClass::CreateHisto(4,"Tau_Jet_phi","Tau_Jet_phi", 40, -3.2, 3.2, "#phi_{jet} (rad)");
    HistClass::CreateHisto(4,"Tau_dxy","Tau_dxy", 100, 0, 0.1, "d_{xy}^{#tau} (cm)");
    HistClass::CreateHisto(4,"Tau_dxy_error","Tau_dxy_error", 100, 0, 0.1, "#sigma(d_{xy}^{#tau}) (cm)");
    HistClass::CreateHisto(4,"Tau_dxy_Sig","Tau_dxy_Sig", 100, 0, 10, "Sig(d_{xy}^{#tau})");
    ...
    HistClass::CreateHisto(4,"Tau_discriminator","Tau_discriminator", 67, 0, 67,"discriminator_{#tau}");
    HistClass::NameBins(3,"Tau_discriminator",67,d_mydisc);


    HistClass::CreateHisto("Muon_num","Muon_num", 40, 0, 39,"N_{#mus}");
    HistClass::CreateHisto(4,"Muon_pt","Muon_pt", 5000, 0, 5000,"p_{T}^{#mu} (GeV)");
    HistClass::CreateHisto(4,"Muon_eta","Muon_eta", 80, -4, 4,"#eta_{#mu}");
    HistClass::CreateHisto(4,"Muon_phi","Muon_phi", 40, -3.2, 3.2,"#phi_{#mu} (rad)");
    ...
    HistClass::CreateHisto(4,"Muon_ET_MET","Muon_ET_MET",50, 0, 6,"p^{#mu}_{T}/E^{miss}_{T}");


    HistClass::CreateHisto(4,"Muon_Vtx_X","Muon_Vtx_X", 100, -1, 1,"Vtx_{x}^{#mu} (cm)");
    HistClass::CreateHisto(4,"Muon_Vtx_Y","Muon_Vtx_Y", 100, -1, 1,"Vtx_{y}^{#mu} (cm)");
    HistClass::CreateHisto(4,"Muon_Vtx_Z","Muon_Vtx_Z", 200, -30, 30,"Vtx_{z}^{#mu} (cm)");
    HistClass::CreateHisto(4,"Muon_Chi2","Muon_Chi2", 400, 0, 200,"#chi_{#mu}^{2}");
    HistClass::CreateHisto(4,"Muon_Ndof","Muon_Ndof", 200, 0, 200,"N_{dof}^{#mu}");
    HistClass::CreateHisto(4,"Muon_LHits","Muon_LHits", 20, 0, 20,"N_{lost hits}^{#mu}");
    HistClass::CreateHisto(4,"Muon_VHits","Muon_VHits", 100, 0, 100,"N_{valid hits}^{#mu}");
    HistClass::CreateHisto(4,"Muon_VHitsPixel","Muon_VHitsPixel", 20, 0, 20,"N_{valid pixel hits}^{#mu}");
    HistClass::CreateHisto(4,"Muon_VHitsTracker","Muon_VHitsTracker", 40, 0, 40,"N_{valid tracker hits}^{#mu}");
    HistClass::CreateHisto(4,"Muon_VHitsMuonSys","Muon_VHitsMuonSys", 60, 0, 60,"N_{valid muon system hits}^{#mu}");
    HistClass::CreateHisto(4,"Muon_TrackerLayersWithMeas","Muon_TrackerLayersWithMeas", 20, 0, 20,"N_{tracker layers with hits}^{#mu}");
    HistClass::CreateHisto(4,"Muon_PixelLayersWithMeas","Muon_PixelLayersWithMeas", 60, 0, 60,"N_{pixel layers with hits}^{#mu}");
    HistClass::CreateHisto(4,"Muon_NMatchedStations","Muon_NMatchedStations", 60, 0, 60,"N_{matched muon stations}^{#mu}");
    HistClass::CreateHisto(4,"Muon_qoverp","Muon_qoverp", 200, 0, 0.2,"#frac{q_{mu}}{p_{mu}}");
    HistClass::CreateHisto(4,"Muon_qoverpError","Muon_qoverpError", 100, 0, 0.001,"#sigma(#frac{q_{mu}}{p_{mu}})");
    HistClass::CreateHisto(4,"Muon_ptError","Muon_ptError", 1000, 0, 1000,"#sigma(p_{T}^{#mu}) (GeV)");
    HistClass::CreateHisto(4,"Muon_Cocktail_pt","Muon_Cocktail_pt", 5000, 0, 5000,"p_{T}^{cocktail #mu} (GeV)");
    HistClass::CreateHisto(4,"Muon_Cocktail_eta","Muon_Cocktail_eta", 80, -4, 4,"#eta_{cocktail #mu}");
    HistClass::CreateHisto(4,"Muon_Cocktail_phi","Muon_Cocktail_phi", 40, -3.2, 3.2,"#phi_{cocktail #mu} (rad)");
    HistClass::CreateHisto(4,"Muon_CaloIso","Muon_CaloIso", 100, 0, 100,"ISO_{Calo}^{#mu} (GeV)");
    ...
    HistClass::CreateHisto(4,"Ele_CaloIso","Ele_CaloIso", 100, 0, 100,"CaloIso");
    HistClass::CreateHisto(4,"Ele_ChargeMatch","Ele_ChargeMatch", 100, 0, 100,"ChargeMatch");
    HistClass::CreateHisto(4,"Ele_Class","Ele_Class", 100, 0, 100,"Class");
    HistClass::CreateHisto(4,"Ele_DEtaSCCalo","Ele_DEtaSCCalo", 100, 0, 100,"DEtaSCCalo");
    HistClass::CreateHisto(4,"Ele_DEtaSCVtx","Ele_DEtaSCVtx", 100, 0, 100,"DEtaSCVtx");
    HistClass::CreateHisto(4,"Ele_DEtaSeedTrk","Ele_DEtaSeedTrk", 100, 0, 100,"DEtaSeedTrk");
    HistClass::CreateHisto(4,"Ele_DPhiSCVtx","Ele_DPhiSCVtx", 100, 0, 100,"DPhiSCVtx");
    HistClass::CreateHisto(4,"Ele_DPhiSeedTrk","Ele_DPhiSeedTrk", 100, 0, 100,"DPhiSeedTrk");
    HistClass::CreateHisto(4,"Ele_Dsz","Ele_Dsz", 100, 0, 100,"Dsz");
    HistClass::CreateHisto(4,"Ele_DszBS","Ele_DszBS", 100, 0, 100,"DszBS");
    HistClass::CreateHisto(4,"Ele_Dxy","Ele_Dxy", 100, 0, 100,"Dxy");
    HistClass::CreateHisto(4,"Ele_DxyBS","Ele_DxyBS", 100, 0, 100,"DxyBS");
    HistClass::CreateHisto(4,"Ele_Dz","Ele_Dz", 100, 0, 100,"Dz");
    HistClass::CreateHisto(4,"Ele_DzBS","Ele_DzBS", 100, 0, 100,"DzBS");
    HistClass::CreateHisto(4,"Ele_ECALIso","Ele_ECALIso", 100, 0, 100,"ECALIso");
    HistClass::CreateHisto(4,"Ele_ECALIso03","Ele_ECALIso03", 100, 0, 100,"ECALIso03");
    HistClass::CreateHisto(4,"Ele_ECALIso04","Ele_ECALIso04", 100, 0, 100,"ECALIso04");
    HistClass::CreateHisto(4,"Ele_ESCOverPout","Ele_ESCOverPout", 100, 0, 100,"ESCOverPout");
    HistClass::CreateHisto(4,"Ele_ESCSeedOverP","Ele_ESCSeedOverP", 100, 0, 100,"ESCSeedOverP");
    HistClass::CreateHisto(4,"Ele_ESCSeedPout","Ele_ESCSeedPout", 100, 0, 100,"ESCSeedPout");
    HistClass::CreateHisto(4,"Ele_EoP","Ele_EoP", 100, 0, 100,"EoP");
    HistClass::CreateHisto(4,"Ele_GSFNormChi2","Ele_GSFNormChi2", 100, 0, 100,"GSFNormChi2");
    HistClass::CreateHisto(4,"Ele_HCALIso","Ele_HCALIso", 100, 0, 100,"HCALIso");
    HistClass::CreateHisto(4,"Ele_HCALIso03","Ele_HCALIso03", 100, 0, 100,"HCALIso03");
    HistClass::CreateHisto(4,"Ele_HCALIso03d1","Ele_HCALIso03d1", 100, 0, 100,"HCALIso03d1");
    HistClass::CreateHisto(4,"Ele_HCALIso03d2","Ele_HCALIso03d2", 100, 0, 100,"HCALIso03d2");
    HistClass::CreateHisto(4,"Ele_HCALIso04","Ele_HCALIso04", 100, 0, 100,"HCALIso04");
    HistClass::CreateHisto(4,"Ele_HCALIso04d1","Ele_HCALIso04d1", 100, 0, 100,"HCALIso04d1");
    HistClass::CreateHisto(4,"Ele_HCALIso04d2","Ele_HCALIso04d2", 100, 0, 100,"HCALIso04d2");
    HistClass::CreateHisto(4,"Ele_HCALIsoConeDR03_2012","Ele_HCALIsoConeDR03_2012", 100, 0, 100,"HCALIsoConeDR03_2012");
    HistClass::CreateHisto(4,"Ele_HCALIsoConeDR04_2012","Ele_HCALIsoConeDR04_2012", 100, 0, 100,"HCALIsoConeDR04_2012");
    HistClass::CreateHisto(4,"Ele_HCALOverECALd1","Ele_HCALOverECALd1", 100, 0, 100,"HCALOverECALd1");
    HistClass::CreateHisto(4,"Ele_HoEm","Ele_HoEm", 100, 0, 100,"HoEm");
    HistClass::CreateHisto(4,"Ele_HoverE2012","Ele_HoverE2012", 100, 0, 100,"HoverE2012");
    HistClass::CreateHisto(4,"Ele_Match","Ele_Match", 100, 0, 100,"Match");
    HistClass::CreateHisto(4,"Ele_NinnerLayerLostHits","Ele_NinnerLayerLostHits", 20, 0, 20,"NinnerLayerLostHits");
    HistClass::CreateHisto(4,"Ele_NumBrems","Ele_NumBrems", 100, 0, 100,"NumBrems");
    HistClass::CreateHisto(4,"Ele_PErr","Ele_PErr", 100, 0, 100,"PErr");
    HistClass::CreateHisto(4,"Ele_SCE","Ele_SCE", 100, 0, 100,"SCE");
    HistClass::CreateHisto(4,"Ele_SCEErr","Ele_SCEErr", 100, 0, 100,"SCEErr");
    HistClass::CreateHisto(4,"Ele_SCEt","Ele_SCEt", 100, 0, 100,"SCEt");
    HistClass::CreateHisto(4,"Ele_SCeta","Ele_SCeta", 100, 0, 100,"SCeta");
    HistClass::CreateHisto(4,"Ele_TrackerP","Ele_TrackerP", 1000, 0, 1000,"TrackerP");
    HistClass::CreateHisto(4,"Ele_TrkIso","Ele_TrkIso", 100, 0, 100,"TrkIso");
    HistClass::CreateHisto(4,"Ele_TrkIso03","Ele_TrkIso03", 100, 0, 100,"TrkIso03");
    HistClass::CreateHisto(4,"Ele_TrkIso04","Ele_TrkIso04", 100, 0, 100,"TrkIso04");
    HistClass::CreateHisto(4,"Ele_Vtx_X","Ele_Vtx_X", 100, -50, 50,"Vtx_X");
    HistClass::CreateHisto(4,"Ele_Vtx_Y","Ele_Vtx_Y", 100, -50, 50,"Vtx_Y");
    HistClass::CreateHisto(4,"Ele_Vtx_Z","Ele_Vtx_Z", 100, -50, 50,"Vtx_Z");
    HistClass::CreateHisto(4,"Ele_chargedHadronIso","Ele_chargedHadronIso", 100, 0, 100,"chargedHadronIso");
    HistClass::CreateHisto(4,"Ele_convDcot","Ele_convDcot", 100, 0, 100,"convDcot");
    HistClass::CreateHisto(4,"Ele_convDist","Ele_convDist", 100, 0, 100,"convDist");
    HistClass::CreateHisto(4,"Ele_convRadius","Ele_convRadius", 100, 0, 100,"convRadius");
    HistClass::CreateHisto(4,"Ele_e1x5","Ele_e1x5", 100, 0, 100,"e1x5");
    HistClass::CreateHisto(4,"Ele_e2x5","Ele_e2x5", 100, 0, 100,"e2x5");
    HistClass::CreateHisto(4,"Ele_e5x5","Ele_e5x5", 100, 0, 100,"e5x5");
    HistClass::CreateHisto(4,"Ele_neutralHadronIso","Ele_neutralHadronIso", 100, 0, 100,"neutralHadronIso");
    HistClass::CreateHisto(4,"Ele_photonIso","Ele_photonIso", 100, 0, 100,"photonIso");
    HistClass::CreateHisto(4,"Ele_pin","Ele_pin", 1000, 0, 1000,"pin");
    HistClass::CreateHisto(4,"Ele_pout","Ele_pout", 1000, 0, 1000,"pout");
    HistClass::CreateHisto(4,"Ele_puChargedHadronIso","Ele_puChargedHadronIso", 100, 0, 100,"puChargedHadronIso");
    HistClass::CreateHisto(4,"Ele_sigmaIetaIeta","Ele_sigmaIetaIeta", 100, 0, 10,"sigmaIetaIeta");
            ...
            for(unsigned char ti=0; ti<2; ti++){ // loop over type
                for(unsigned char ui=0; ui<2; ui++){ // loop over updown
                    HistClass::CreateHisto(boost::format("3_%s_pt_syst_%s%s%s")%particles[pi] %shifted[si] %type[ti] %updown[ui],
                                           boost::format("3_%s_pt_syst_%s%s%s")%particles[pi] %shifted[si] %type[ti] %updown[ui],
                                           5000, 0, 5000,
                    ...
                    HistClass::CreateHisto(boost::format("3_%s_eta_syst_%s%s%s")%particles[pi] %shifted[si] %type[ti] %updown[ui],
                                           boost::format("3_%s_eta_syst_%s%s%s")%particles[pi] %shifted[si] %type[ti] %updown[ui],
                                           5000, 0, 5000,
                    ...
                    HistClass::CreateHisto(boost::format("3_%s_phi_syst_%s%s%s")%particles[pi] %shifted[si] %type[ti] %updown[ui],
                                           boost::format("3_%s_phi_syst_%s%s%s")%particles[pi] %shifted[si] %type[ti] %updown[ui],
                                           40, -3.2, 3.2,
                    ...
                    HistClass::CreateHisto(boost::format("3_%s_DeltaPhi_syst_%s%s%s")%particles[pi] %shifted[si] %type[ti] %updown[ui],
                                           boost::format("3_%s_DeltaPhi_syst_%s%s%s")%particles[pi] %shifted[si] %type[ti] %updown[ui],
                                           40, 0, 3.2,
                    ...
                    HistClass::CreateHisto(boost::format("3_%s_mt_syst_%s%s%s")%particles[pi] %shifted[si] %type[ti] %updown[ui],
                                           boost::format("3_%s_mt_syst_%s%s%s")%particles[pi] %shifted[si] %type[ti] %updown[ui],
                                           5000, 0, 5000,
                    ...
                    HistClass::CreateHisto(boost::format("3_%s_ET_MET_syst_%s%s%s")%particles[pi] %shifted[si] %type[ti] %updown[ui],
                                           boost::format("3_%s_ET_MET_syst_%s%s%s")%particles[pi] %shifted[si] %type[ti] %updown[ui],
                                           50, 0, 6,
                    ...
                    HistClass::CreateHisto(boost::format("3_%s_met_syst_%s%s%s")%particles[pi] %shifted[si] %type[ti] %updown[ui],
                                           boost::format("3_%s_met_syst_%s%s%s")%particles[pi] %shifted[si] %type[ti] %updown[ui],
                                           5000, 0, 5000,
                                           "E^{miss}_{T} (GeV)");
                    HistClass::CreateHisto(boost::format("3_%s_met_phi_syst_%s%s%s")%particles[pi] %shifted[si] %type[ti] %updown[ui],
                                           boost::format("3_%s_met_phi_syst_%s%s%s")%particles[pi] %shifted[si] %type[ti] %updown[ui],
    ...
    //HistClass::CreateHisto(4, "Ele_pt_systScaleUp",     "Ele_pt_systScaleUp", 5000, 0, 5000,"p_{T}^{e} (GeV)");
    //HistClass::CreateHisto(4, "Ele_pt_systScaleDown",   "Ele_pt_systScaleDown", 5000, 0, 5000,"p_{T}^{e} (GeV)");
    //HistClass::CreateHisto(4, "Ele_eta_systScaleUp",    "Ele_eta_systScaleUp", 80, -4, 4,"#eta_{e}");
    //HistClass::CreateHisto(4, "Ele_eta_systScaleDown",  "Ele_eta_systScaleDown", 80, -4, 4,"#eta_{e}");
    //HistClass::CreateHisto(4, "Ele_phi_systScaleUp",    "Ele_phi_systScaleUp", 40, -3.2, 3.2,"#phi_{e} (rad)");
    //HistClass::CreateHisto(4, "Ele_phi_systScaleDown",  "Ele_phi_systScaleDown", 40, -3.2, 3.2,"#phi_{e} (rad)");
    //HistClass::CreateHisto(4, "Muon_pt_systScaleUp",    "Muon_pt_systScaleUp", 5000, 0, 5000,"p_{T}^{#mu} (GeV)");
    //HistClass::CreateHisto(4, "Muon_pt_systScaleDown",  "Muon_pt_systScaleDown", 5000, 0, 5000,"p_{T}^{#mu} (GeV)");
    //HistClass::CreateHisto(4, "Muon_eta_systScaleUp",   "Muon_eta_systScaleUp", 80, -4, 4,"#eta_{#mu}");
    //HistClass::CreateHisto(4, "Muon_eta_systScaleDown", "Muon_eta_systScaleDown", 80, -4, 4,"#eta_{#mu}");
    //HistClass::CreateHisto(4, "Muon_phi_systScaleUp",   "Muon_phi_systScaleUp", 40, -3.2, 3.2,"#phi_{#mu} (rad)");
    //HistClass::CreateHisto(4, "Muon_phi_systScaleDown", "Muon_phi_systScaleDown", 40, -3.2, 3.2,"#phi_{#mu} (rad)");
    //HistClass::CreateHisto(4, "Tau_pt_systScaleUp",     "Tau_pt_systScaleUp", 5000, 0, 5000, "p_{T}^{#tau} (GeV)");
    //HistClass::CreateHisto(4, "Tau_pt_systScaleDown",   "Tau_pt_systScaleDown", 5000, 0, 5000, "p_{T}^{#tau} (GeV)");
    //HistClass::CreateHisto(4, "Tau_eta_systScaleUp",    "Tau_eta_systScaleUp", 80, -4, 4, "#eta_{#tau}");
    //HistClass::CreateHisto(4, "Tau_eta_systScaleDown",  "Tau_eta_systScaleDown", 80, -4, 4, "#eta_{#tau}");
    //HistClass::CreateHisto(4, "Tau_phi_systScaleUp",    "Tau_phi_systScaleUp", 40, -3.2, 3.2, "#phi_{#tau} (rad)");
    //HistClass::CreateHisto(4, "Tau_phi_systScaleDown",  "Tau_phi_systScaleDown", 40, -3.2, 3.2, "#phi_{#tau} (rad)");
//
    //HistClass::CreateHisto(4, "Ele_pt_systResolutionUp",     "Ele_pt_systResolutionUp", 5000, 0, 5000,"p_{T}^{e} (GeV)");
    //HistClass::CreateHisto(4, "Ele_pt_systResolutionDown",   "Ele_pt_systResolutionDown", 5000, 0, 5000,"p_{T}^{e} (GeV)");
    //HistClass::CreateHisto(4, "Ele_eta_systResolutionUp",    "Ele_eta_systResolutionUp", 80, -4, 4,"#eta_{e}");
    //HistClass::CreateHisto(4, "Ele_eta_systResolutionDown",  "Ele_eta_systResolutionDown", 80, -4, 4,"#eta_{e}");
    //HistClass::CreateHisto(4, "Ele_phi_systResolutionUp",    "Ele_phi_systResolutionUp", 40, -3.2, 3.2,"#phi_{e} (rad)");
    //HistClass::CreateHisto(4, "Ele_phi_systResolutionDown",  "Ele_phi_systResolutionDown", 40, -3.2, 3.2,"#phi_{e} (rad)");
    //HistClass::CreateHisto(4, "Muon_pt_systResolutionUp",    "Muon_pt_systResolutionUp", 5000, 0, 5000,"p_{T}^{#mu} (GeV)");
    //HistClass::CreateHisto(4, "Muon_pt_systResolutionDown",  "Muon_pt_systResolutionDown", 5000, 0, 5000,"p_{T}^{#mu} (GeV)");
    //HistClass::CreateHisto(4, "Muon_eta_systResolutionUp",   "Muon_eta_systResolutionUp", 80, -4, 4,"#eta_{#mu}");
    //HistClass::CreateHisto(4, "Muon_eta_systResolutionDown", "Muon_eta_systResolutionDown", 80, -4, 4,"#eta_{#mu}");
    //HistClass::CreateHisto(4, "Muon_phi_systResolutionUp",   "Muon_phi_systResolutionUp", 40, -3.2, 3.2,"#phi_{#mu} (rad)");
    //HistClass::CreateHisto(4, "Muon_phi_systResolutionDown", "Muon_phi_systResolutionDown", 40, -3.2, 3.2,"#phi_{#mu} (rad)");
    //HistClass::CreateHisto(4, "Tau_pt_systResolutionUp",     "Tau_pt_systResolutionUp", 5000, 0, 5000, "p_{T}^{#tau} (GeV)");
    //HistClass::CreateHisto(4, "Tau_pt_systResolutionDown",   "Tau_pt_systResolutionDown", 5000, 0, 5000, "p_{T}^{#tau} (GeV)");
    //HistClass::CreateHisto(4, "Tau_eta_systResolutionUp",    "Tau_eta_systResolutionUp", 80, -4, 4, "#eta_{#tau}");
    //HistClass::CreateHisto(4, "Tau_eta_systResolutionDown",  "Tau_eta_systResolutionDown", 80, -4, 4, "#eta_{#tau}");
    //HistClass::CreateHisto(4, "Tau_phi_systResolutionUp",    "Tau_phi_systResolutionUp", 40, -3.2, 3.2, "#phi_{#tau} (rad)");
    //HistClass::CreateHisto(4, "Tau_phi_systResolutionDown",  "Tau_phi_systResolutionDown", 40, -3.2, 3.2, "#phi_{#tau} (rad)");
...
void specialAna::KinematicsSelector() {
    ...
    if( EleList->size()==1 && TauList->size()==0 && MuonList->size()==0 ){
    ...
    if( EleList->size()==0 && TauList->size()==0 && MuonList->size()==1 ){
    ...
    if( EleList->size()==0 && TauList->size()==1 && MuonList->size()==0 ){
